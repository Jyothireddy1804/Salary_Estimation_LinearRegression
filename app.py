...
input_age 22-60 = st.number_input('Age', min_value=22, max_value=60)
...
input_years_of_experience = st.number_input('Years of Experience', min_value=0, max_value=20, value=0)
